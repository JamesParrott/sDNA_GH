...
class MyComponent(component):
    ...
    def RunScript(self, unload, update):
        ...
        print('sDNA_GH imported == ' + str(is_imported('sDNA_GH')))
        print('sDNA_GH.tools imported == ' + str(is_imported('sDNA_GH.tools')))
        print('sDNAUISpec imported == ' + str(is_imported('sDNAUISpec')))
        print('runsdnacommand == ' + str(is_imported('runsdnacommand')))
